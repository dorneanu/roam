...
*Context:* The book opens by situating itself within the [[id:5d80a36d-b497-4db9-a0f8-77b3b95de166][Anthropocene]] paradigm — the recognition that human civilisation is now the dominant force shaping the Earth system. This framing elevates the stakes: the question is not incremental policy but civilisational trajectory.
...
*Context:* The book's central prescription, stated succinctly. The five turnarounds are not aspirational goals but quantified policy packages modelled in the [[id:08470b4c-4b45-4650-a6a9-067f801f94bb][Earth4All]] system-dynamics simulation. Each comes with specific targets and mechanisms.
...
*The five turnarounds at a glance* — each a quantified policy package in the [[id:08470b4c-4b45-4650-a6a9-067f801f94bb][Earth4All model]]:
- *Poverty* — rapid, fairer growth for low-income nations: ≥5%/yr GDP growth until >$15,000 per person; reform the international financial system; new wellbeing indicators.
- *Inequality* — the richest 10% take less than 40% of national income, via progressive and wealth taxes, stronger labour, and dividends from a Citizens Fund.
- *Empowerment of women* — gender equity plus investment in education and health, helping stabilise global population below 9 billion by 2050.
- *Food* — a regenerative, nature-positive food system by 2050: healthy diets for all, no net cropland expansion, drastically reduced food waste.
- *Energy* — halve greenhouse-gas emissions roughly every decade to net-zero by 2050, via efficiency and a rapid wind/solar rollout.
...
*The five dimensions of wellbeing* (WEAll) — proposed in place of GDP as the measure of success in a [[id:d112fb80-8110-47c9-a1eb-01415d3eed34][wellbeing economy]]:
- *Dignity* — everyone has enough to live in comfort, health, safety, and happiness.
- *Nature* — a restored and safe natural world for all life.
- *Connection* — a sense of belonging and institutions that serve the common good.
- *Fairness* — justice across all dimensions; the gap between richest and poorest greatly reduced.
...
- *Difficulty:* wealth flows to the owners of assets and of the commons (land, IP, fossil fuels, the right to pollute) rather than to the workers and citizens who collectively own them.
- *Solution:* Citizens Funds — industries pay fees for using the commons; the revenue is returned to every citizen equally as a universal basic dividend (the inequality lever of the [[id:0d4ac54d-ec52-4c0f-b947-cc9d6e80c052][Giant Leaps]]).
...
- *Problem:* [[id:73226fcb-1702-4d6b-a4ba-b66bbae65c2a][CO₂]] emissions are counted where goods are produced, not consumed, so rich countries outsource both the factory and the blame to low-income producers.
- *Solution:* move to consumption-based carbon accounting so responsibility — and any tariffs or financing — follows the consumer, paired with knowledge and finance transfer to measure and cut emissions.
...
- *Difficulty:* nascent green industries in developing nations cannot compete with established international players if exposed to open markets too early.
- *Solution:* revive the "infant industry" model — temporary import protection (as used by South Korea and China to escape the middle-income trap) to let local green investment mature.
...
- *Problem:* beyond the 10:40 income ratio, social and health problems worsen, cohesion frays, and governments lose the ability to make long-term decisions.
- *Target:* cap the richest 10% at no more than the combined income of the poorest 40% — a "tolerable" ceiling on inequality.
...
- *Myth:* inequality is a necessary incentive that makes people work harder.
- *Evidence:* unsupported — extreme inequality is a destructive force that erodes the social fabric collective action depends on.
...
- *Difficulties:* persistent gender power imbalances; and an information ecosystem in which social media has industrialised misinformation, polarising societies and eroding the shared facts cooperation requires.
- *Solutions:* invest in education and health for all and empower women (helping stabilise population below 9 billion by 2050); rebuild curricula on two foundations — critical thinking and complex systems thinking.
...
- *Difficulties:* the Western diet drives ~10 million premature deaths a year, while hundreds of millions still suffer undernutrition; markets place no value on sustainable or regenerative farming.
- *Solutions:* shift to a planetary health diet (far more fruit, vegetables, legumes, nuts, seeds) tackling over- and under-consumption; make agriculture regenerative and nature-positive; use active government to price in sustainable practice.
...
- *The apparent difficulties are myths, not physics:*
  - "Transitions are slow" → we are 30 years in; renewables are now at cost parity or cheaper.
  - "Some sectors can't be electrified" → new solutions decarbonise trucking, shipping, cement, steel.
  - "Behaviour won't change" → the pandemic showed behaviour and business models can shift fast.
  - "EVs are inferior" → EVs out-perform on speed/acceleration with ~20 moving parts vs up to 2,000.
  - "Intermittency makes it unreliable" → offset with overcapacity, storage, and super grids.
...
- *Solutions for the energy turnaround:*
  - Systemic efficiency — meeting needs with services rather than raw energy can cut final energy demand ~40% by 2050.
  - Electrify (almost) everything — replace burning coal, oil, gas and trees with electrons.
  - Scale new renewables — wind and solar get ~20–25% cheaper per doubling of capacity (learning curves fossil fuels lack).
  - Halve [[id:73226fcb-1702-4d6b-a4ba-b66bbae65c2a][CO₂]] and other greenhouse-gas emissions roughly every decade to net-zero by 2050.
...
- *Problem:* the lever to change the system sits in one place — the economy — yet it stays unpulled.
- *Solutions (the five levers):*
  - Citizens Funds to share the wealth of the global commons fairly.
  - Active government — subsidies, incentives, regulation — to accelerate the turnarounds.
  - Transform the international financial system to fund poverty alleviation in "Most of the World".
  - De-risk investment in low-income countries and cancel unfair debt.
  - Invest in efficient, regenerative food and renewable energy systems.
...
- *Narrative 1 — postwar Keynesian (1945–1975):* a business/labour/government split aiming at full employment and safety nets; brought stability and greater equality.
- *Narrative 2 — market liberalisation (~1980–2008):* globalisation for efficiency; finance deregulated and dominant; new problems — private debt, weakened infrastructure, short-termism, rising inequality.
- *Narrative 3 — the rentier economy (post-2008):* money made on money and asset values rather than production; concentrates wealth and undermines democratic governance.
- *Implication:* the rentier turn is the structural root the turnarounds must reverse.
...
- *Problem:* the commons — the ultimate source of all wealth — is unpriced, so it is easy to ignore and to destroy.
- *Solution:* rebuild an economic operating system that values the commons — community-based production and reciprocal exchange of surpluses ("become Indigenous again").
...
- *Problem:* in a rentier economy money "trickles up" from producers and households through finance to asset owners, while a weakened government looks on.
- *Solutions (three levers redirect the flows):*
  - Citizens Fund — adds nature as a money tree; dividends shift wealth back to workers and households.
  - Regulate finance — channel lending away from fossil fuels and unsustainable agriculture toward clean energy and regenerative practice.
  - Cancel unfair debt — writing off ~$900bn frees nearly a billion people's spending for poverty relief and resource renewal.
...
- *Reframing:* measure success by the total stock of capital (produced, human, natural) maintained over time, not annual GDP flows.
- *Effect:* ecosystem restoration and social investment become visible as wealth creation rather than cost — the [[id:d112fb80-8110-47c9-a1eb-01415d3eed34][wellbeing economy]] as the destination of the Giant Leap.
