...
#+filetags: :journal:
  ...
  - [[https://aws.plainenglish.io/provisioning-aws-sso-permissions-with-cdk-5ab492ef73d2][Provision AWS SSO permission sets using CDK (typescript)]] ([[id:61b1e794-8d3a-45f1-b414-612b6ad4dad4][CDK]])
   - 2022-08-23 ◦ [[https://github.com/markilott/aws-cdk-sso-permission-sets][GitHub - markilott/aws-cdk-sso-permission-sets: AWS SSO Permission Sets with CDK]]

    #+begin_quote
    In CDK there are no Level 2 constructs, but we can use the [[https://docs.aws.amazon.com/cdk/v2/guide/constructs.html][L1 CloudFormation constructs]] for Permission Sets to:
