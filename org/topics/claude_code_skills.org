...
| # | Skill | Best for | Repo |
|---+-------+----------+------|
| 1 | [[https://github.com/gsd-build/get-shit-done][GSD (Get-Shit-Done)]] | Large, iterative projects with many phases | github.com/gsd-build/get-shit-done |
| 2 | [[https://github.com/obra/superpowers][Superpowers]] | Small-medium, well-defined projects; brainstorming | github.com/obra/superpowers |
| 3 | [[https://github.com/rebelytics/one-skill-to-rule-them-all][Meta-skill (self-improving)]] | Autonomously improves your other skills over time | github.com/rebelytics/one-skill-to-rule-them-all |
| 4 | /close | End-of-session context persistence; memory + git | (prompt-only, see below) |
| 5 | [[https://github.com/tonone-ai/tonone][tonone]] | Multi-agent team with 23 specialist agents | github.com/tonone-ai/tonone |
| 6 | [[https://github.com/6eanut/llm-wiki][LLM wiki]] | Karpathy wiki pattern as a Claude Code skill | github.com/6eanut/llm-wiki |
| 7 | [[https://github.com/karpathy/llm-council][LLM Council]] | Multi-model decisions; creative friction | github.com/karpathy/llm-council |
| 8 | [[https://github.com/agentrhq/authsome][authsome]] | Credential management; authenticated API calls | github.com/agentrhq/authsome |
...
* Inter-agent messaging skill (agent-channel)
...
See [[id:60eb9b01-7f41-4bd7-94db-32d7a5f3aace][Multi-agent communication]] for the full protocol, platform support matrix,
and relationship to other agentic patterns.

Repo: https://github.com/fl4p/agent-channel (MIT licensed)

* Browser automation skill (ego-browser)

`ego-browser` connects any agent CLI (Claude Code, Codex, Cursor) to
[[id:e65ed367-0759-4149-840f-b80e463afe5a][ego lite]], a macOS browser designed to be shared between a human and their
...
- [[id:60eb9b01-7f41-4bd7-94db-32d7a5f3aace][Multi-agent communication]] — file-based inter-agent messaging protocol; NDJSON channels, kqueue/inotify wake-up, cross-harness interop
- [[id:e65ed367-0759-4149-840f-b80e463afe5a][ego lite]] — browser automation skill; shared human+agent browser with isolated per-agent Spaces
- [[id:8fd21c64-2e57-41ae-b962-02f256b1e80c][Browser automation]] — broader landscape of programmatic browser control tools
* Resources
...
- 2026-06-25 ◦ [[https://github.com/fl4p/agent-channel][agent-channel (GitHub, fl4p)]] — install as a Claude Code plugin; enables zero-CPU file-based messaging between Claude Code, Codex, and OpenCode agents in separate sessions
- 2026-07-30 ◦ [[https://github.com/citrolabs/ego-lite][ego-lite (GitHub, citrolabs)]] — `ego-browser` skill connects Claude Code and other agent CLIs to a shared human+agent browser; see [[id:e65ed367-0759-4149-840f-b80e463afe5a][ego lite]]
