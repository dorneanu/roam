...
- User reinitctxoffset keeps a serious feature branch on every project driven manually in Emacs (or VS Code), using the Emacs package =gptel= as a smarter search engine — it tool-calls out for docs — rather than as a code generator. This deliberately trades some speed for keeping reflexes up and comprehension debt under control (see [[id:faffc96d-bac0-4b98-9691-62ead0171129][Cognitive offloading]] for the fuller comprehension-debt argument).
