...
* Overview
Cognitive offloading is the transfer of thinking, decision-making, or skill practice onto an external tool — a calculator, a search engine, or, increasingly, an AI. A 2026 [[https://news.ycombinator.com/item?id=48908178][HN discussion]] (420 comments, score 456) of the article [[https://www.artfish.ai/p/offloading-thinking-to-ai][Are we offloading too much of our thinking to AI?]] (yenniejun111) opens with a widely-cited framing device: the "Whispering Earring," a magic item from a fantasy short story that always tells its wearer the objectively best decision to make. Commenters used the earring as a lens for AI assistants — treat AI as a whispering earring ("what should we do now?") and you outsource judgment itself; treat it as an exoskeleton (execute an already-decided plan) and you outsource only labor.
#+begin_quote
