...
[[id:ba94d644-46d1-42b3-bb38-15b0b5cb50ec][Instruction hierarchy]] systems rely on role tags (~<system>~, ~<user>~, ~<tool>~) to
assign privilege levels. However, models do not authenticate roles by their
structural tags — they perceive roles by the *style and content* of the text. A
message written to sound like a system instruction will be treated as one
regardless of which tag wraps it. This is the root cause identified as
[[id:a7cf523b-afd4-401b-bc40-2a8041fb8b80][role confusion in LLMs]] (Ye et al., 2026).
...
- *Role probes* — mechanistic interpretability tools (see [[id:a7cf523b-afd4-401b-bc40-2a8041fb8b80][role confusion in LLMs]])
...
- 2026-07-02 ◦ [[https://arxiv.org/html/2603.12277v6][Prompt Injection as Role Confusion (Ye et al.)]] — traces prompt injection to [[id:a7cf523b-afd4-401b-bc40-2a8041fb8b80][role confusion]]: models perceive roles by text style not structural tags; introduces CoT Forgery (~60% ASR) and role probes as mechanistic interpretability tools
