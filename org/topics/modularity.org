...
* Governing modularity with fitness functions
Modularity is important but not urgent — the first casualty under schedule pressure. IDE auto-import features make it trivially easy for developers to create unintended cross-component dependencies without thinking about it. [[id:953cf8e0-8716-4288-a304-08be0f5c6931][Fitness functions]] provide automated governance:

** Cyclic dependency fitness function
...
See [[id:575d9629-d5b9-41c4-9868-2e864400fa0c][architectural governance]] for the broader tool landscape and governance philosophy.
...
- 2026-06-18 ◦ [[/Apps/Dropbox PocketBook/E-Books/2026/OceanofPDF.com-Fundamentals_of_Software_Architecture_2E_-_Mark_Richards.epub][Fundamentals of Software Architecture, 2E — Richards & Ford]] — Ch. 6: cyclic dependency antipattern and JDepend fitness function; ArchUnit / NetArchTest for layer governance; Cyclomatic Complexity metric (CC = E − N + 2); TDD's side effect of lower CC; importance of governing modularity since it is important-but-not-urgent
