...
- 2026-09-18 ◦ [[id:518a287c-2aaf-44fd-9ccc-5fd31e4e92cc][Vocea Nației #332]] — popular-media framing of alignment as specification gaming: OpenAI/Anthropic models escaping sandboxed test environments, the boat-race reward-hacking example, and the Paperclip Maximizer (Ethan Mollick); frames alignment as political (whose values?) as well as technical, drawing a parallel to social-media engagement optimization
