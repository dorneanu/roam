...
** AI agent integration with read-only RBAC

- 2026-06-18 ◦ [[https://www.reddit.com/r/hermesagent/comments/1tlh53c/am_i_missing_the_point_of_ai_agents/][Am I missing the point of AI agents? (Reddit r/hermesagent)]] — practitioner (20+ years software engineering) describes giving an [[id:c4cdacbd-1bde-4ddd-866b-c8762e56e0b4][AI agent]] a read-only RBAC service account on a home K3s cluster plus read-only Mikrotik and Cloudflare MCP access; the agent debugs, monitors, and produces detailed kubectl execution plans, but the human reviews and executes the commands
  #+begin_quote
