...
### Higher profit vs efficiency {#higher-profit-vs-efficiency}
...
### Company of One vs Freelancing {#company-of-one-vs-freelancing}
...
### Minimum Viable Profit (MVPr) {#minimum-viable-profit--mvpr}
...
### Focus on relationships {#focus-on-relationships}
...
## ROWE (Results-Only Work Environments) {#rowe--results-only-work-environments}
...
### Introverted Leaders {#introverted-leaders}
...
### Autonomy vs Alignment {#autonomy-vs-alignment}
...
## Customers related {#customers-related}
...
### Build a fan base {#build-a-fan-base}
...
### Earn trust not money {#earn-trust-not-money}
...
### Types of capital {#types-of-capital}
...
### Story of Pinboard {#story-of-pinboard}
...
Also check [So good they can't ignore you]({{< relref "so_good_they_can_t_ignore_you.md" >}})
