...
## On the Importance of Deep Work {#on-the-importance-of-deep-work}


### Constantly learn new things {#constantly-learn-new-things}
...
> The ability to perform is becoming increasingly rare at exactly the same time it
...
>
> -   [Why is it so hard to do my work](https://www.sciencedirect.com/science/article/abs/pii/S0749597809000399)
...
#### The Intelectual Life {#the-intelectual-life}
...
#### Law of productivity {#law-of-productivity}
...
> As Gallagher recalls in her 2009 book [Rapt](https://www.goodreads.com/book/show/6262510-rapt), as she walked away from the hospital after the
...
-   The connection between [deep work]({{< relref "../../topics/deep_work.md" >}}) and flow should be clear
...
-  By Roy Baumeister
    ...
    > The key to developing a [deep work]({{< relref "../../topics/deep_work.md" >}}) habit is to move beyond good intentions and add routines
...
-  Different philosophies
    ...
    -  Monastic
        ...
        > Knuth deploys what I call the monastic philosophy of [deep work]({{< relref "../../topics/deep_work.md" >}}) scheduling. This philosophy
        > attempts to maximize deep efforts by eliminating or radically minimizing [shallow]({{< relref "../../topics/shallow_work.md" >}})
    ...
    -  Bimodal
        ...
        > Jung's approach is what I call the bimodal philosophy of [deep work]({{< relref "../../topics/deep_work.md" >}}). This philosophy asks
...
-  Cognitive capacity and deep work
    ...
    > Then there's the issue of cognitive capacity. is exhausting because it pushes
...
-   A commitment to is not a moral stance and it's not aphilosophical statement
    -   it is instead a pragmatic recognition that the ability to concentrate is a skill that [gets valuable things done]({{< relref "getting_things_done_the_art_of_stress_free_productivity.md" >}})