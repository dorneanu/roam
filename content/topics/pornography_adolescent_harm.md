...
## Prevalence and gender asymmetry {#prevalence-and-gender-asymmetry}
...
## Mechanisms of harm {#mechanisms-of-harm}
...
## Contrast with printed pornography {#contrast-with-printed-pornography}
...
## Generative AI and the coming intensification {#generative-ai-and-the-coming-intensification}

Haidt warns that the harms from pornography are likely to intensify with the metaverse, spatial video, and generative AI, which can produce three-dimensional pornography featuring "perfect" synthetic people. AI-powered virtual companions (e.g., CarynAI) already demonstrate that many users form genuine emotional attachments to chatbots. As these systems improve and are embedded in physical sex dolls, heterosexual men may increasingly prefer a [hikikomori]({{< relref "anomie.md" >}}) lifestyle with a programmable companion over the social risk of real-world dating.
