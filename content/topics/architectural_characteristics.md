...
_([Fundamentals of Software Architecture, 2E]({{< relref "../books/fundamentals_of_software_architecture.md" >}}), Ch. 4)_
...
_([Fundamentals of Software Architecture, 2E]({{< relref "../books/fundamentals_of_software_architecture.md" >}}), Ch. 5)_
...
_([Fundamentals of Software Architecture, 2E]({{< relref "../books/fundamentals_of_software_architecture.md" >}}), Ch. 6)_
...
Once defined and measured, characteristics are enforced through [fitness functions]({{< relref "fitness_functions.md" >}}) — see .
