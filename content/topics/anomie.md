...
(Durkheim, _Suicide_, 1897)


## Durkheim's core argument {#durkheim-s-core-argument}
...
## Anomie and the phone-based childhood {#anomie-and-the-phone-based-childhood}
...
## Communities vs. networks {#communities-vs-dot-networks}

Haidt draws a sharp distinction between communities and networks, drawing on Durkheim:

-   **Community**: known individuals, high barriers to entry and exit, persistent membership, shared history, real accountability, able to generate and enforce norms
-   **Network**: mix of known and unknown participants, many using aliases, most of whom will have vanished by next year or next month; daily tornado of memes, fads, and micro-dramas with a rotating cast of millions of bit players
...
## Hikikomori as an extreme expression of anomie {#hikikomori-as-an-extreme-expression-of-anomie}
...
-   [Phone-based childhood]({{< relref "phone_based_childhood.md" >}}) — the structural cause of the contemporary anomie epidemic among Gen Z
-   [Gaming addiction]({{< relref "gaming_addiction.md" >}}) — one path by which boys enter anomic disengagement from the real world
-   [Pornography and adolescent harm]({{< relref "pornography_adolescent_harm.md" >}}) — another pull factor that deepens boys' retreat from real-world social risk
-   [Sociogenic illness]({{< relref "sociogenic_illness.md" >}}) — structural normlessness (anomie) leaves adolescents without stable identity anchors, making them more susceptible to online identity models and sociogenic transmission of disorders
