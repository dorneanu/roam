...
## Leap 1: End poverty {#leap-1-end-poverty}
...
## Leap 2: Tackle inequality {#leap-2-tackle-inequality}
...
-   Inequality matters for planetary stability because: (a) the ultra-rich consume far more resources per capita; (b) high-inequality societies are less trusting, less cooperative, and less able to enact collective climate action; (c) [Social comparison]({{< relref "social_comparison.md" >}}) driven by inequality generates psychological harm that undermines wellbeing even as GDP rises
...
## Leap 3: Empower women {#leap-3-empower-women}
...
## Leap 4: Transform food {#leap-4-transform-food}
...
## Leap 5: Accelerate clean energy transition {#leap-5-accelerate-clean-energy-transition}
