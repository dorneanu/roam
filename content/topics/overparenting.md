...
-   [Mean World Syndrome]({{< relref "mean_world_syndrome.md" >}}): media creates inflated perception of danger
...
## Consequences for children {#consequences-for-children}
...
-   Systematic production of [Learned Helplessness]({{< relref "learned_helplessness.md" >}})
-   40% of US high school students reported persistent sadness or hopelessness (CDC, 2023)


## Connection to safetyism {#connection-to-safetyism}
...
## The breakdown of adult solidarity (Furedi) {#the-breakdown-of-adult-solidarity--furedi}
...
## Fearful parenting and the age of liberation {#fearful-parenting-and-the-age-of-liberation}
...
See also: [Mean World Syndrome]({{< relref "mean_world_syndrome.md" >}}), [Phone-Based Childhood]({{< relref "phone_based_childhood.md" >}}), [Antifragility]({{< relref "antifragility.md" >}}), [Safetyism]({{< relref "safetyism.md" >}})
