...
-   **Anxiety variant**: abdominal pain, headache, dizziness, fainting, nausea, and hyperventilation as the most common symptoms
-   **Motor variant**: involuntary movement — "hysterical dancing," convulsions, laughing, and pseudoseizures; "dancing plagues" in medieval Europe are the most dramatic historical examples
...
## Social media as a vector: mass social media-induced illness {#social-media-as-a-vector-mass-social-media-induced-illness}
...
## Mechanism: emotional contagion + prestige bias + audience capture {#mechanism-emotional-contagion-plus-prestige-bias-plus-audience-capture}
...
## Disorders spreading sociogenically via social media {#disorders-spreading-sociogenically-via-social-media}

Evidence suggests multiple disorders have been spreading sociogenically, especially via TikTok, YouTube, and Instagram:

-   Functional tic disorders (see above)
-   Dissociative identity disorder (DID): once rare, DID has been growing since TikTok's rise, primarily among adolescent girls; influencers portraying multiple personalities attract millions of followers; hashtag #did alone has 2.8 billion views
-   Gender dysphoria: while some increase reflects genuine "coming out," the clustering of gender dysphoria within friend groups and the sharp sex-ratio reversal (natal females now outnumbering natal males among Gen Z) are consistent with sociogenic transmission in addition to biological variation
-   Anxiety and depression themselves may have spread partly via sociogenic mechanisms, given the pace and simultaneity of their increase across many countries


## Why adolescent girls are most vulnerable {#why-adolescent-girls-are-most-vulnerable}
...
-   Girls are more emotionally expressive and more effective at communicating mood states within friendship pairs; when a woman becomes depressed, it raises depression risk in close friends by 142% (Christakis/Fowler)
-   Girls are more likely to talk about feelings, creating more vectors for emotional contagion
-   Girls gravitated to visually oriented social media (Instagram, TikTok) rather than text-based platforms, which are more effective at transmitting emotional and physical cues
-   The most extreme symptom presentations rise in prominence on these platforms, becoming the models that other girls learn from via prestige bias


## Connection to related topics {#connection-to-related-topics}

-   [Social comparison]({{< relref "social_comparison.md" >}}) — prestige bias and social learning are the shared mechanism behind both sociogenic illness and social comparison harm; prestige bias is the reason extreme presentations rise to the top
-   [Phone-based childhood]({{< relref "phone_based_childhood.md" >}}) — the Great Rewiring created the conditions for social media-induced illness by putting millions of adolescent girls into a globally networked emotional system
-   [Anomie]({{< relref "anomie.md" >}}) — structural normlessness that leaves adolescents searching for identity online, making them more susceptible to online identity-formation via prestige models
