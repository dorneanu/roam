...
## Attention Fragmentation as Foundational Harm {#attention-fragmentation-as-foundational-harm}

Jonathan Haidt identifies attention fragmentation as one of four foundational harms of the [Phone-Based Childhood]({{< relref "phone_based_childhood.md" >}}):
...
### The Goldilocks effect {#the-goldilocks-effect}
...
### Deep reading and brain plasticity {#deep-reading-and-brain-plasticity}
...
The hopeful corollary: plasticity works in both directions. Just as skimming rewires toward shallowness, deliberate practice of deep attention rewires back toward it. Wolf recovered her ability to read deeply within two weeks of sustained effort. This is the same logic as [Deep Work]({{< relref "deep_work.md" >}}): the capacity is not lost, merely suppressed by habit, and can be recultivated deliberately.
