...
### The simulation problem {#the-simulation-problem}
...
## Scale in the LLM era {#scale-in-the-llm-era}
...
-   [Phone-based childhood]({{< relref "phone_based_childhood.md" >}}) — children who lack face-to-face conversation practice may be more vulnerable to the ELIZA effect
-   [Attention Economy]({{< relref "attention_economy.md" >}}) — AI companions are a new frontier of the attention economy: monetizing the human need for connection
