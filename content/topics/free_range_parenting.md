...
## Evidence for children's need for independence {#evidence-for-children-s-need-for-independence}
...
## What children develop through unstructured, unsupervised time {#what-children-develop-through-unstructured-unsupervised-time}
...
## Barriers in English-speaking cultures {#barriers-in-english-speaking-cultures}
...
-   [Mean World Syndrome]({{< relref "mean_world_syndrome.md" >}}) from media and neighborhood apps
-   [Safetyism]({{< relref "safetyism.md" >}}) culture that mistakes avoidance for care


## Haidt's four reforms (practical free-range guidance) {#haidt-s-four-reforms--practical-free-range-guidance}
...
See also: [Antifragility]({{< relref "antifragility.md" >}}), [Phone-Based Childhood]({{< relref "phone_based_childhood.md" >}})
