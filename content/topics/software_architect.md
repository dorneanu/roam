...
-   2026-06-16 ◦ [Fundamentals of Software Architecture, 2E — Richards &amp; Ford]({{< relref "../books/fundamentals_of_software_architecture.md" >}}) — Ch. 1–2: eight expectations in full detail (pp. 41–58); leadership as "at least half" the role; organizational politics as a core architect competency; all eight expectations quoted from user's reading notes
