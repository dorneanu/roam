...
## Antifragility in child development {#antifragility-in-child-development}
...
## The antifragility argument against safetyism {#the-antifragility-argument-against-safetyism}

Haidt's central critique of [Safetyism]({{< relref "safetyism.md" >}}) is that it is anti-antifragile. By removing small stressors — the playground risks, the neighborhood conflicts, the unstructured challenges — parents and schools eliminate the very inputs that build psychological strength. The result is a generation of children who enter adolescence and adulthood chronically in defend mode rather than a discover-oriented default (see [Safetyism]({{< relref "safetyism.md" >}})).
...
## Relationship to risky play {#relationship-to-risky-play}
...
When children are prevented from experiencing challenge, they do not develop the experience that their actions have consequences and that they can handle difficulty. This is the mechanism by which overprotection produces [Learned Helplessness]({{< relref "learned_helplessness.md" >}}) — a belief that effort is futile because children never had the chance to discover that effort works.
