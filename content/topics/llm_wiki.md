...
-   2026-06-18 ◦ [Am I missing the point of AI agents? (Reddit r/hermesagent)](https://www.reddit.com/r/hermesagent/comments/1tlh53c/am_i_missing_the_point_of_ai_agents/) — a practitioner describes a personal knowledge base [AI agent]({{< relref "ai_agents.md" >}}) that "finds connections, opportunities and news and finds paths that I likely would not have found manually" — serendipitous cross-topic discovery as the primary value over simple retrieval
